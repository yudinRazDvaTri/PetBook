...
//This method shows template role.
//Roles are also enums. Which allows painlessly expanding program
...
//this method allows user choose the role in site, also generates the template, witch needed to the role
