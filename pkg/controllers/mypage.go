...
//The handler chooses to display contents of the page through the id and role parameters in context
...
// Еhe method displays the page of the animal on which there is a navbar, logo, characteristics, gallery, blog and footer
...
// Еhe method displays the page of the veterinary on which there is a navbar, logo, characteristics, gallery, blog and footer
...
// Handler allows to display other users, with their data and role dependency
