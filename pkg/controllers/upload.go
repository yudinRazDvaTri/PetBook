...
//Handler, which allow add some photos to the gallery
//Creates ./web/static/usermedia/{id}/gallery/ folder
...
//This func walks through the folder and adds files to the slice
...
//Handler, which allow add photo to the logo,each last added photo will be displayed
...
// This function helps to adjust the path picture for windows
...
// In this handler, the image is deleted from the database and folder.
// The path is got from the button to remove what is next to the picture
