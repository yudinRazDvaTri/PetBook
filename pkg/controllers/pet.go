...
// This handler allows you to register an animal using html forms
//Also u can skip pet registration and add it later
...
//This handler shows the animal registration form
//Enums are used in one of the forms, which allows painlessly expanding animal species
